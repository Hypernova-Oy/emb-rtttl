...
XS(_wrap_play_rtttl) {
  {
    ...
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: play_rtttl(pin,notes);");
    }
    ecode1 = SWIG_AsVal_int SWIG_PERL_CALL_ARGS_2(ST(0), &val1);
    if (!SWIG_IsOK(ecode1)) {
      SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "play_rtttl" "', argument " "1"" of type '" "int""'");
    } 
    arg1 = (int)(val1);
    res2 = SWIG_AsCharPtrAndSize(ST(1), &buf2, NULL, &alloc2);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "play_rtttl" "', argument " "2"" of type '" "char *""'");
    }
    arg2 = (char *)(buf2);
    play_rtttl(arg1,arg2);
